...
- **Finance Center (2026-07)**: Назорат + **Cash Exchange** (replaces Float top-up): `cashExchange` / `walletToCash` / `migrateFloatToWallet`. Settlements/Journal/Closing/Exceptions unchanged. P2P in user wallet UI.
