...
///
/// Scaffold'сиз body widget: [YukIntercityScreen] ичида кўрсатилади.
...
class YukIntercityBoard extends StatefulWidget {
  const YukIntercityBoard({
    super.key,
  ...
  @override
  State<YukIntercityBoard> createState() => _YukIntercityBoardState();
}

class _YukIntercityBoardState extends State<YukIntercityBoard> {
  ...
  String get _ownerPhone => widget.ownerPhone;
