...
**1-босқич — УСТУВОР (эга томонидан алоҳида таъкидланган):**
1. **Adaptive/predictive prefetch** — [TvPlayerPool](lib/features/tv_market/services/tv_player_pool.dart) нинг ҳозирги фиксланган қоидасини (жорий клип ≥4s буферланса ёки 2.5s timeout, ҳамма учун бир хил) [TvNetworkQualityService](lib/features/tv_market/services/tv_network_quality_service.dart)га (ҳозир фақат улаgish тури — Wi-Fi/мобил; реал bandwidth-эстимация билан кенгайтириш керак, масалан `TvPlaybackAnalyticsRecorder` орқали) ва фойдаланувчи scroll тезлигига боғлаш — заиф тармоқда prefetch кечиктирилади/кичраяди, тез свайпда кейинги клиплар олдинроқ тайёрланади.
2. **Қисқа HLS сегментлар** — `TV_CLIP_HLS_SEGMENT_SECONDS`ни ([functions/index.js:11127](functions/index.js:11127)) 4 дан Instagram'дек 2–3 сонияга тушириш. **Эслатма:** фақат янги transcode қилинадиган клипларга таъсир қилади (мавжудлари backfill қилинмаса 4s'да қолади); сегмент қисқариши manifest ҳажмини оширади, шунинг учун аввал кичик гуруҳда синаб, `playbackStats` орқали (b40bb65'даги услубда) реал таъсирини ўлчаш тавсия этилади.

**2-босқич — pipeline'ни тезлаштириш:**
Барча sifat вариантларини кутиш ўрнига, энг паст (360p) вариантни биринчи ясаб, тайёр бўлган заҳоти алоҳида белги (`lowQualityReady`) билан белгилаш — фойдаланувчи тўлиқ pipeline тугашини кутмасдан томоша қила олади (YouTube/TikTok'нинг progressive availability усули).

**3-босқич — узоқ муддатли (инфратузилма):**
Cache-Control сарлавҳаси аллақачон тўғри ('public, max-age=31536000, immutable', ҳам original ҳам variant файлларда) — лекин Firebase Storage ҳозир ҳақиқий CDN edge тармоғи орқали эмас, тўғридан-тўғри us-central1'дан хизмат қилади. Cloud CDN (HTTPS Load Balancer + GCS backend) орқали видео хизмат қилишни кўриб чиқиш — катта, пуллик, лекин узоқ муддатда энг юқори таъсирли қадам.
