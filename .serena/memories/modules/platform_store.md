...
Fields: name, description, price(int), imageUrl, unit, minQty, step, totalStock(0=unlimited), soldToday, active, featuredOnHome, showInMarket, sortOrder, createdAt, updatedAt.
