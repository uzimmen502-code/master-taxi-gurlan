...
- Firebase: Phone Auth, Firestore, Cloud Functions (`firebase-functions` 4.9.0, Node.js 20 1st Gen), Hosting, FCM, Crashlytics (mobile `firebase_crashlytics`; web skip).
