...
class _AddAdViewState extends State<_AddAdView> {
  ...
  Future<void> _submit() async {
    ...
    navigator.pop();
    final live = result.status == 'active';
    messenger.showSnackBar(SnackBar(
      content: Text(
        live ? 'Эълон жойланди' : 'Эълон текширувга юборилди',
      ),
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            sel ? col : JobsColors.fieldFill,
                                        borderRadius:
                                            BorderRadius.circular(10),
                                        border: Border.all(
                                          color:
                                              sel ? col : JobsColors.border,
                                        ),
                                      ),
                                      child: Row(
                                        mainAxisSize: MainAxisSize.min,
                        ...
                        TextField(
                          ...
                          style: const TextStyle(color: JobsColors.ink),
                          decoration: _fieldDecoration(
                            label: _kind == AdKind.ad
                                ? 'Нарх (ихтиёрий)'
                                : 'Нарх / шартнома (ихтиёрий)',
                            hint: _kind == AdKind.ad
                                ? 'Масалан: 200 000 сўм'
                                : 'Масалан: келишув асосида',
                            showCounter: false,
                          ).copyWith(
                            isDense: true,
