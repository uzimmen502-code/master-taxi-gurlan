...
**Ҳолат (2026-09-25):** `fix/intercity-taxi-qa` шохчаси `feat/home-redesign`га бирлаштирилди; callable'лар **деплой қилинди**; `firestore.rules` **атайлаб деплой қилинмади**.

**Муаммо (2026-09-24 QA):** `intercity_drivers.seats` майдонини ҳар қандай чақирувчи — ҳатто тизимга кирмагани ҳам — қайта ёза оларди; йўловчи эса ўзини `status: confirmed` қилиб, ҳайдовчи тасдиғини айланиб ўта оларди.

**Қилинди:** `intercityCreateBooking` / `intercityCancelBooking` / `intercityCompleteBooking` (us-central1, Admin SDK) — бронь, ўрин, нарх ва статус энди СЕРВЕРДА; илова шуларни чақиради; қоидаларда `intercityDriverSeatBookingPatch()` ва мижознинг create/cancel/complete йўллари олиб ташланди. Эмулятор тести: `npm --prefix functions run test:intercity`.

**Нега қоидалар деплой қилинмади:** Play'даги жорий версия броньни ҳали ҳам мижозда яратади. Қоидалар ҳозир деплой қилинса — **эски иловадаги фойдаланувчилар брон қила олмай қолади**.
