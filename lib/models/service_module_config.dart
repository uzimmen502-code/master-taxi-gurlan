...
/// Home xizmatlar grididagi xizmatlar bilan sinxron.
const List<String> kKnownModuleIds = [
  'local_taxi',
  'intercity',
  'marshrut',
  // Yuk birjasi — 2026-09 dan ikki alohida modul (eski yagona `yuk_birja`
  // migratsiyasi yakunlangan, config'da alohida sozlanadi).
  'yuk_local',
  'yuk_intercity',
  'courier',
  'sell',
